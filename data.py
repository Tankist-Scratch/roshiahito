...
pages = {"VD-U" : """{{Card|VD-U||L||T.S|40|40|10|2}}VD-U - первый робот ветки внедорожников. Первый раз принял участие в [[Robofinist (2017)|'Ралли по коридору']] в 2017 году.<br>""""",
         "Robofinist (2017)" : """<a href='//robofinist.ru/event/info/competitions/id/132#kind957'>Ралли по коридору</a>""",
         "T.Tr" : """{{Card|T.Tr||mB|||40|40|10|2}}T.Tr - самый первый робот собраный на MakeBlock. Хорошо подходит для езды по линии.""",
