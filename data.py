...
pages = {
    "RW-U": """{{Card|RW-U||L||T.S|40|40|10|2}}RW-U - первый робот ветки внедорожников. Первый раз принял участие в [[Robofinist 2017|'Ралли по коридору']] в 2017 году.<br>
    
    <h2>История</h2>
    """"",
    "Robofinist 2017": """{{BCard|Robofinist|28/10/2017 – 29/10/2017|https://robofinist.ru/event/info/competitions/id/132#kind957}}""",
    "T.Tr": """{{Card|T.Tr||mB|||20|19.5|10|1}}T.Tr - самый первый робот собраный на MakeBlock. Хорошо подходит для езды по линии.<br>
    ...
    "T.S": """{{Card|T.S||L|RW-U||40|40|10|2}}T.S - тележка построеная на базе [[RW-U|RW-U]]. Унаследовала помещение электроники в трубу, что увеличивает количество мест для крепления.""",
