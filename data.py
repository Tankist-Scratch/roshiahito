...
pages = {
    "RW-U": """{{Card|RW-U||L|||{{robolink|T.S|T.s|}}|40|40|20|1}} RW-U - первый робот ветки внедорожников. Первый раз принял участие в [[Robofinist 2017|'Ралли по коридору']] в 2017 году.<br>
    
    {{h2|История|History}}
    {{id|RW-U-a}}
    {{Card|RW-U-a||L|||{{robolink|RW-U-b|#RW-U-b|}}|40|40|20|1}}
    {{id|RW-U-b}}
    {{Card|RW-U-b||L||{{robolink|RW-U-a|#RW-U-a|}}|{{robolink|RW-U-c|#RW-U-c|}}|40|40|20|1}}
    {{id|RW-U-c}}
    {{Card|RW-U-c||L||{{robolink|RW-U-b|#RW-U-b|}}||40|40|20|1}}
    """"",
    "Robofinist 2017": """{{BCard|Robofinist|28/10/2017 – 29/10/2017|https://robofinist.ru/event/info/competitions/id/132#kind957}}""",
    "T.Tr": """{{Card|RW-U||L|||{{robolink|T.S|T.s|}}|40|40|20|1}}T.Tr - самый первый робот собраный на MakeBlock. Хорошо подходит для езды по линии.<br>
         
         <h2>Модули</h2>
         {{mod|mB-Line-U|mB-Line|mB-Line-U}}
         
         <h2>Соревнования</h2>
         {{battle|Собери своего робота 2017|Полигон|Собери своего робота 2017|1|T.Tr Line-U}}""",
    "T.S": """{{Card|RW-U||L|||{{robolink|T.S|T.s|}}|40|40|20|1}}T.S - тележка построеная на базе {{robolink|RW-U|RW-U|}}. Унаследовала помещение электроники в трубу, что увеличивает количество мест для крепления.""",
