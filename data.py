...
pages = {"VD I" : """{{Card|VD I||L||Tel.S|40|40|10|2}}VD I - первый робот ветки внедорожников. Первый раз принял участие в [[Robofinist (2017)|'Ралли по коридору']] в 2017 году.<br>""""",
         ...
         "Tel.S" : """{{Card|Tel.S||L|VD I||40|40|10|2}}Tel.S - тележка построеная на базе [[VD I|VD I]]. Унаследовала помещение электроники в трубу, что увеличивает количество мест для крепления."""}
all = ["VD"]
